...
//}
//
//template<typename T> Vector<T> Matrix<T>::getColumn(const int col)const{
//
//    return Vector<T>(data + col, xDim, yDim);
//}
//
//template<typename T> Vector<T> Matrix<T>::getRow(const int row)const{
//    return Vector<T>(data + row * stride, 0, xDim);
//}
//
//
